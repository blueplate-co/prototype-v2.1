                ...
                <div className="container">
                    ...
                    <div className={(this.state.hidden) ? 'row toggle-content hidden' : 'row toggle-content open'}>
                        <div className="col l4 m12 s12 choosing-item">
                            <div className="choosing-image-container" style={{ backgroundImage: "url(" + 'https://s3-ap-southeast-1.amazonaws.com/blueplate-images/images/choosing1.png' + ")" }}></div>
                        ...
                        <div className="col l4 m12 s12 choosing-item">
                            <div className="choosing-image-container" style={{ backgroundImage: "url(" + 'https://s3-ap-southeast-1.amazonaws.com/blueplate-images/images/choosing2.png' + ")" }}></div>
                        ...
                        <div className="col l4 m12 s12 choosing-item">
                            <div className="choosing-image-container" style={{ backgroundImage: "url(" + 'https://s3-ap-southeast-1.amazonaws.com/blueplate-images/images/choosing3.png' + ")" }}></div>
