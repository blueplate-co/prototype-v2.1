...
FlowRouter.triggers.enter([isNotLoggedIn],{
  except: ['Landing Page', 'Blueplate Seller Handbook']
});
...
FlowRouter.triggers.enter([isNotBlueplateUser], {
  only: ['Change Password', 'Kitchens Distribution', 'Util']
})
...
FlowRouter.route('/util',{
  name: 'Util',
  action() {
    BlazeLayout.render('screen',{render_component:'util'})
  }
});
...
FlowRouter.route('/internal/kitchens_map', {
  ...
  action() {
    BlazeLayout.render('screen',{render_component:'kitchen_mapping'});
  }
})
...
FlowRouter.route('/internal/access_denied', {
  name: 'Access Denied',
  action() {
    BlazeLayout.render('screen',{render_component:'access_deny'});
  }
})
