...
FlowRouter.route('/main',{
  ...
  action(){
    import('../client/imports/ui/show_room').then((ShowRoom) => {
      const showroomcomponent = ShowRoom.default;
      render(React.createElement(showroomcomponent), document.getElementById('show_room_container'));
    });
  }
});
...
FlowRouter.route('/shopping_cart',{
  ...
  action() {
    import('../client/imports/ui/shopping_cart').then((ShoppingCart) => {
      const ShoppingCartComponent = ShoppingCart.default;
      render(React.createElement(ShoppingCartComponent), document.getElementById('shoppingcart-container'));
    });
  }
});
...
FlowRouter.route('/dish/:dish_id',{
  ...
  action() {
    import('../client/imports/ui/dish_detail').then((Dish_Detail) => {
      const dishdetailcomponent = Dish_Detail.default;
      let id = FlowRouter.getParam("dish_id");
      render(React.createElement(dishdetailcomponent, {id: id}), document.getElementById('dish_detail_container'));
    });
  }
});
