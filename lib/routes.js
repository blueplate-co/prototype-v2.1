...
FlowRouter.route('/internal_users',{
  name: 'Internal_users',
  action() {
    BlazeLayout.render('internal_users',{navbar: "ui_navbar",content:'ui_login'});
  }
});
...
FlowRouter.route('/add_notes',{
  name: 'add_notes',
  action() {
    BlazeLayout.render('add_notes');
  }
});
