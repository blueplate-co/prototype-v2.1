...
FlowRouter.route('/seller_handbook/post/articles',{
...
FlowRouter.route('/seller_handbook/edit/articles/:article_id',{
...
FlowRouter.route('/seller_handbook/',{
  name: 'Blueplate Seller Handbook',
  action() {
    BlazeLayout.render('screen',{render_component:'seller_handbook'});
  }
});

FlowRouter.route('/seller_handbook/category/:category',{
  name: 'Blueplate Seller Handbook',
  action() {
    BlazeLayout.render('screen',{render_component:'shb_articles'});
  }
});

FlowRouter.route('/seller_handbook/articles/:article_id',{
  name: 'Blueplate Seller Handbook',
  action() {
    BlazeLayout.render('screen',{render_component:'shb_article_display'});
  }
});
